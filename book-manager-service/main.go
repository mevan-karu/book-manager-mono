...
func initDB() {
	...
	host := getEnv("CHOREO_CONNECTION_BOOK_MANAGER_SERVICE_DEFAULTDB_HOSTNAME", getEnv("DB_HOSTNAME", "localhost"))
	port := getEnv("CHOREO_CONNECTION_BOOK_MANAGER_SERVICE_DEFAULTDB_PORT", getEnv("DB_PORT", "5432"))
	user := getEnv("CHOREO_CONNECTION_BOOK_MANAGER_SERVICE_DEFAULTDB_USERNAME", getEnv("DB_USERNAME", "postgres"))
	password := getEnv("CHOREO_CONNECTION_BOOK_MANAGER_SERVICE_DEFAULTDB_PASSWORD", getEnv("DB_PASSWORD", "password"))
	dbname := getEnv("CHOREO_CONNECTION_BOOK_MANAGER_SERVICE_DEFAULTDB_DATABASENAME", getEnv("DB_NAME", "defaultdb"))
